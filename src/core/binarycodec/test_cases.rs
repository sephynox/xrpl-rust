...
fn _load_tests() -> &'static Option<TestDefinitions> {
    pub const DATA_DRIVEN_TESTS: &str = include_str!("data/data-driven-tests.json");
    pub const CODEC_TEST_FIXTURES: &str = include_str!("data/codec-fixtures.json");
    pub const X_CODEC_TEST_FIXTURES: &str = include_str!("data/x-codec-fixtures.json");
